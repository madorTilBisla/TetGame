var objConcept = [
    ...
    {
         "concept": "חזרה על נהלים",
         "shape": "shape1.png",
         "category": "1"
     },
     {
        "concept": "יצירת קשר אישי",
         "shape": "shape2.png",
         "category": "3"
    },
    {
         "concept": "התערבות מכחידה",
         "shape": "shape3.png",
         "category": "1"
    }
    ];
...
function IsRight() {
    if ((objConcept[nCountShape].category === "1" && PositionXCounter === 6) || (objConcept[nCountShape].category === "2" && PositionXCounter === 35) || (objConcept[nCountShape].category === "3" && PositionXCounter === 64)) {
        ...
        if(nCountRight === 19) {
            ...
            setTimeout(function(){ strRightMsg.style.opacity = "0"; }, 1000);
        }
    } else {
        ...
        if(nCountWrong === 1) {
            ...
            setTimeout(function(){ strWrongmsg.style.opacity = "0"; }, 1000);
        }
        nCountWrong--;
    }
}
